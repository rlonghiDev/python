...
#As jogadas irão acrescentar X ou O nas posições da Matriz conforme as jogadas forem acontecendo
tabuleiro = [[1,2,3],[4,5,6],[7,8,9]]
#tabuleiro = [['X','X','X'],['X','X','X'],['X','X',9]]  
...
while True:
    ...
    #Se a célula já estiver ocupada pede nova jogada 
    ...
    for i in range(2):
        ...
        if cont1 == cont2 and cont2 == cont3:
            print("O jogador com ",cont1," ganhou o jogo")
            time.sleep(3)
            break
